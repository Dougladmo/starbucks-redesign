  ...
  return (
    <div className='w-full m-auto bg-transparent'>
        <div className='flex justify-between md:justify-center items-center px-16'>
            ...
            <a href="#" className='bg-green text-sm font-Open shadow-md tracking-wider transition duration-500 text-white px-10 py-3 rounded-xl border-2 border-green hover:text-green hover:bg-blue md:hidden'>Sign in</a>
        </div>
    </div>
  )
}
