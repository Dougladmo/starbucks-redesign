...
export const CardReverseTwo  = ({title, btnText, img}) => {
    return (
      <div className='w-11/12 m-auto text-darkgreen bg-blue bg-center bg-no-repeat bg-cover grid grid-cols-2 items-center justify-center mb-12 md:w-full md:flex md:flex-col-reverse'>
