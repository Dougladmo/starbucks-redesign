...
export const LightButton = ({ text }) => {
  return (
        <button className='py-1 px-5 font-semibold text-base transition duration-200 rounded-full border-solid bg-transparent border border-slate-950 hover:scale-90 hover:shadow-md shadow-black hover:brightness-50'>{text}</button>
    )
}
